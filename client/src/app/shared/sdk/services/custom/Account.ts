...
export class AccountApi extends BaseLoopBackApi {
   ...
   *  - `hasPassword` – `{boolean}` - 
   */
  public checkpassword(id: any = {}, password: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * This method returns no data.
   */
  public resetPasswordChange(password: any = {}, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
